...
app.controller('regionCtrl', function($scope, mapFactory){
    ...
    function action(pFunction) {
        ...
        queue()
            ...
            .defer(d3.csv, 'data/millennials.csv', function (d) {
                if (+d.Year == $scope.selectedYear) {
                    mapByID.set(d.GEOID,
                        {
                            "year": +d.Year, "total": +d["Total Population"],
                            "mil_pop": +d["Millennial Population"],
                            "pct": +d.Pct
                        })
                }
            })
    ...
    function loadShapes (error, blockGrp){
        ...
        var feature = g.selectAll("path")
            ...
            .attr("class", function(d){
                //console.log(mapByID.get(d.properties.GEOID10));
